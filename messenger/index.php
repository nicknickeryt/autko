...
echo '<img src="../res/profpic/default.svg" class="card-img-top userimage align-self-center" alt="">
  <div class="card-body">';
echo '<h5 class="card-title username-label">' . $otherusername . '</h5>
...
if($row["senderid"] == $userid){
  ...
  echo "<p class='message bg-primary message-from text-decoration-none' data-id='" . $row["ID"] . "'>" . $row ["content"] . "</p>";
}
}
